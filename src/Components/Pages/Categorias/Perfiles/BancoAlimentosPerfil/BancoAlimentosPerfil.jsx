...
import DineroComponente from "./ComponenteBancoAlimentos.jsx";
import LogoBancoAlimentos from "./Imagenes/BancoAlimentosLogo.png";

class DineroPerfil extends Component {
  render() {
    ...
    return (
      <div>
        {opcionesDePerfiles.map((opcion, index) => (
          <DineroComponente key={index} opciones={opcion} />
        ))}
      </div>
    );
  }
