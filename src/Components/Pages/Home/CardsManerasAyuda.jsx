      ...
      <>
        <section id="ContainerAyudar">
          <div id="TituloBloqueAyudar">
            <h2 id="TituloAyudar" data-aos="fade-up">
              Maneras de Ayudar
            </h2>
            <p id="DescripcionAyudar" data-aos="fade-up">
              Hay muchas otras maneras de apoyar a la gente más necesitada.
            </p>
          </div>
              ...
              <div className="card" id="card" key={index}>
                <div className="card-body">
                  ...
                  <button
                    ...
                    id="botonDonar"
                    onClick={() => (window.location.href = opcion.url)}
                  >
                    Donar
                  </button>
                </div>
