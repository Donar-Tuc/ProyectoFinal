        ...
        <section id="ComunidadContainer">
          ...
          <form className="formEmail" action="https://api.web3forms.com/submit" method="POST" onSubmit={this.handleSubmit}>
            ...
            <div className="fieldNewsteller">
              ...
              <input className="input-field inputComunidad" type="email" name="email" placeholder="Correo Electrónico" required="required" id="CorreoElectronico" onChange={this.handleChange} />
            </div>
            {/* Mensaje de error */}
