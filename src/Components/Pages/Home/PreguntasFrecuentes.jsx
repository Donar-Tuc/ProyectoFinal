        ...
        <Accordion>
          ...
          <Accordion.Item eventKey="3">
            ...
            <Accordion.Body>
              ...
              registro. Sin embargo, crear una cuenta te permitirá seguir tu
              historial de donaciones y recibir actualizaciones de tus
          ...
          <Accordion.Item eventKey="5">
            ...
            <Accordion.Body>
              ...
              tengas una cuenta con ellos para realizar el pago.
            </Accordion.Body>
          </Accordion.Item>

          <Accordion.Item eventKey="6">
            <Accordion.Header>
              ¿Cómo puedo encontrar fundaciones cerca de mí?
            </Accordion.Header>
            <Accordion.Body>
              Para encontrar fundaciones cerca de tu ubicación, simplemente
              permite que nuestra aplicación acceda a tu ubicación GPS. Luego,
              escoge una categoría de doncación, o bien, ve a “Ver todas las
              categorías“. Los resultados de búsqueda estarán ordenados en base
              a tu ubicación.
            </Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="7">
            ...
            <Accordion.Body>
              ...
              en nuestra sección de "Eventos", donde puedes encontrar
