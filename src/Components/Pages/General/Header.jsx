...
import { HashLink } from "react-router-hash-link"; // Importa HashLink en lugar de Link
...
const links = [
  ...
  {
    name: "Eventos",
    href: "/eventos#EventosTop",
  },
  {
    name: "Soporte",
    href: "/soporte#SoporteTop",
  }
];
        ...
        <nav>
          ...
          <div id="Menu">
            ...
            >
              {links.map((x, index) => (
                <li key={index}>
                  <HashLink smooth to={x.href}>{x.name}</HashLink> {/* Utiliza HashLink con la propiedad smooth */}
                </li>
              ))}
              {LinkLogin.map((x, index) => (
                <li key={index}>
                  <HashLink className="btnLogin" to={x.href}>
                    {x.name}
                  </HashLink>
                </li>
              ))}
